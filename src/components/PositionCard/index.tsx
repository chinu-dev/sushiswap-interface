    ...
    return (
        <>
            {userPoolBalance && JSBI.greaterThan(userPoolBalance.raw, JSBI.BigInt(0)) ? (
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 bg-green rounded p-4 bg-opacity-20 w-full mt-4 whitespace-nowrap">
                ...
                <div className="bg-green rounded p-4 bg-opacity-20 w-full mt-4">
                    <p>
